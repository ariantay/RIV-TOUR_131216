...
/*THIS IS NOW A TEMP CLASS THAT WE WILL USE TO STORE SMALL TEMPLATES*/
...
//*REMINDER -- this whole thing needs a LOT of refactoring, get it to work first though
    ...
    this.render = function() {
		//when we use this in a function, this will refer to the caller
		//since we are using callback this will refer to store
		var self = this;
...
HomeView.locTextTemplate = Handlebars.compile($("#locText-tpl").html());
